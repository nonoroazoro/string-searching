...
/**
 * 计算“好后缀规则表”，记录了所有后缀的位移。以好后缀的“长度 - 1”作为数组索引。
 * 规则：
 * 数组元素按“好后缀”从短到长排序，索引即：length - 1，取到的值就是 shift。例如：好后缀“MPLE”，索引为 4 - 1 = 3，那 [3] 即为对应的位移。
 * 这里为了节省资源，并没有保存所有“好后缀”的 shift。
 * 因此当未找到指定的“好后缀”对应的 shift 时，shift = lengthP - 1 - (-1) = lengthP。
 */
